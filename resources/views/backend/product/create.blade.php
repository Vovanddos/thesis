...
{{--              <option value="1/4">76,5 / 30 (1/4)</option>--}}
{{--              <option value="1/2">82,5 / 34 (1/2)</option>--}}
{{--              <option value="3/4">88,5 / 36 (3/4)</option>--}}
{{--              <option value="4/4">100 / 40 (4/4)</option>--}}
{{--          </select>--}}
{{--        </div>--}}
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="hot">Рспродажа</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
              <span class="input-group-btn">
                  ...
                  <i class="fa fa-picture-o"></i> Выберите
                  </a>
              </span>
