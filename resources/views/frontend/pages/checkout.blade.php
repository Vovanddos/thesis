                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                ...
                                <p>Пожалуйста, зарегистрируйтесь, чтобы оформить заказ быстрее</p>
                                <!-- Form -->
                                <div class="row">
                                    ...
                                    <div class="content">
                                        <ul>
										    <li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">
                                                Стоимость корзины<span>{{number_format(Helper::totalCartPrice(),2)}} руб.</span></li>
                                            <li class="shipping">
                                                Способ доставки
                                            ...
                                            <li class="coupon_price" data-price="{{session('coupon')['value']}}">
                                                Вы сохранили <span>{{number_format(session('coupon')['value'],2)}} руб.</span></li>
                                            @endif
                                            @php
                                            ...
                                            @if(session('coupon'))
                                                <li class="last"  id="order_total_price">
                                                    Всего<span>{{number_format($total_amount,2)}} руб.</span></li>
                                            @else
                                                <li class="last"  id="order_total_price">
                                                    Всего<span>{{number_format($total_amount,2)}} руб.</span></li>
                                            @endif
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method" checked type="radio" value="cod"> <label> Наличными при получении</label><br>
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Новости</h4>
                            <p> Подпишитесь на нашу рассылку и получите купон на скидку в <span>5%</span></p>
	...
	<script>
		$(document).ready(function(){
			$('.shipping select[name=shipping]').change(function(){
				...
				// alert(coupon);
				$('#order_total_price span').text((subtotal + cost-coupon).toFixed(2)+ ' руб.');
			});
