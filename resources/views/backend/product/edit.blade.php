...
<div class="card">
    <h5 class="card-header">Редактировать продукт</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        @csrf
        @method('PATCH')
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Заголовок <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Полное описание</label>
        ...
        <div class="form-group">
          <label for="is_featured">Рекомендация</label><br>
...
{{--                // dd($data);--}}
{{--                @endphp--}}
{{--              <option value="1/4"  @if( in_array( "1/4",$data ) ) selected @endif>1/4</option>--}}
{{--              <option value="1/2"  @if( in_array( "1/2",$data ) ) selected @endif>1/2</option>--}}
{{--              <option value="3/4"  @if( in_array( "3/4",$data ) ) selected @endif>3/4</option>--}}
{{--              <option value="4/4"  @if( in_array( "4/4",$data ) ) selected @endif>4/4</option>--}}
{{--              @endforeach--}}
{{--          </select>--}}
{{--        </div>--}}
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default" {{(($product->condition=='default')? 'selected':'')}}>Обычный</option>
              <option value="new" {{(($product->condition=='new')? 'selected':'')}}>Новый</option>
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Распродажа</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
              <span class="input-group-btn">
                  ...
                  <i class="fas fa-image"></i> Выберите
                  </a>
              </span>
