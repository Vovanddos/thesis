						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Напишите сообщение @auth @else<span style="font-size:12px;" class="text-danger">[Сначала необходимо авторизоваться!]</span>@endauth</h3>
								</div>
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Горячая линяя:</h4>
									<ul>
