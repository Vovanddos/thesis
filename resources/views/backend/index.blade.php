...
@section('title','MUSiC-CORE || DASHBOARD')
...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
          <a href="{{route('category.index')}}"> <div class="card border-left-primary shadow h-100 py-2">
          <div class="card-body">
      ...
      <!-- Products -->
      <div class="col-xl-3 col-md-6 mb-4">
          <a href="{{route('product.index')}}"><div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
      ...
      <!-- Order -->
      <div class="col-xl-3 col-md-6 mb-4">
          <a href="{{route('order.index')}}"> <div class="card border-left-info shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
      ...
      <!--Posts-->
      <div class="col-xl-3 col-md-6 mb-4">
          <a href="{{route('post.index')}}"> <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Посты</div>
