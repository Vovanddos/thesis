                                ...
                                <!-- Single Post -->
                                    ...
                                    <div class="single-post first">
                                        ...
                                        <div class="content">
                                            ...
                                            @endphp
                                            <p class="price">
                                                <del class="text-muted">{{number_format($product->price,2)}}руб.
                                                </del> {{number_format($org,2)}} руб.
                                            </p>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    ...
                                                    <div class="product-action-2">
                                                        <a title="Add to cart"
                                                           href="{{route('add-to-cart',$product->slug)}}">В корзину</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @endphp
                                        <h3><small>
                                                <del class="text-muted">{{number_format($product->price,2)}} руб.</del>
                                            </small> {{number_format($after_discount,2)}} руб.
                                        </h3>
